...
with app.app_context():
    ...
    category = Category(name=category_name, alias=category_alias, description=category_description, image_url=image_url)
    ...
    challenge = Challenge(title=challenge_title, alias=challenge_alias, description=challenge_description, files=challenge_files, resources=challenge_resources, flag=challenge_flag, course_id=1, category_id=1)
